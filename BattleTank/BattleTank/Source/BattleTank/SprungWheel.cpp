...
{
    //UE_LOG(LogTemp, Warning, TEXT("In OnHit() in frame %f"), GetWorld()->GetTimeSeconds())
    //ApplyDrivingForce(NormalImpulse.Size());
    ApplyForce();
...
void ASprungWheel::Tick(float DeltaTime)
{
    ...
    //UE_LOG(LogTemp, Warning, TEXT("In Tick in frame %f"), GetWorld()->GetTimeSeconds())
